...
- Docs: root README.md + README.en.md (both version lines set to v5.5.0; lifecycle-semantics + starter loop), docs/TECHNICAL_GUIDE.md(+zh) outcome sentence, docs/AUDIT_REPORT.md, skill/SKILL.md, builder README template.
...
A12. **Versions**: builder:71 -> '1.1.0'; root package.json -> 5.5.0; SKILL.md:6 & AUDIT_REPORT:38 -> v5.5.0; README.md:140 AND README.en.md:140 both SET to `v5.5.0` (overwrite drifted 5.4.6/5.4.5; do not increment locally).
